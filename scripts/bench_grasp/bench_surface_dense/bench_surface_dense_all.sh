...
# Main configurations
CHECKPOINTS="${HOME_DIR}/results/grasp_surface_dense/r01.pth ${HOME_DIR}/results/grasp_surface_dense/r02.pth ${HOME_DIR}/results/grasp_surface_dense/r03.pth ${HOME_DIR}/results/grasp_surface_dense/r04.pth ${HOME_DIR}/results/grasp_surface_dense/r05.pth"
...
#INPUT="${HOME_DIR}/datasets/cat1/A/House_without_roof_00057_vox12.ply"
COMPUTE_D2="True"
