...
# Main configurations
CHECKPOINTS="${HOME_DIR}/results/train_grasp_quad/epoch_newest.pth"
...
INPUT="${HOME_DIR}/datasets/cat1/A/soldier_viewdep_vox12.ply ${HOME_DIR}/datasets/cat1/A/boxer_viewdep_vox12.ply ${HOME_DIR}/datasets/cat1/A/Facade_00009_vox12.ply"
COMPUTE_D2="True"
