...
# Main configurations
NET_CONFIG="${HOME_DIR}/config/net_config/grasp_diffusion_jointly.yaml"
OPTIM_CONFIG="${HOME_DIR}/config/optim_config/optim_diffusion_r01_warmup.yaml"
...
ALPHA="100" # distortion trade-off
BETA="0.01" # rate trade-off
SCALING_RATIO="0.5" # quantization ratio
