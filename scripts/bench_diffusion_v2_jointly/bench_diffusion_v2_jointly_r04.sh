...
# Main configurations
CHECKPOINTS="${HOME_DIR}/results/train_diffusion_v2_jointly_r04/epoch_newest.pth"
CHECKPOINT_NET_CONFIG="False"
NET_CONFIG="${HOME_DIR}/config/net_config/grasp_diffusion_jointly_r04.yaml"
CODEC_CONFIG="${HOME_DIR}/config/codec_config/grasp_diffusion_allsteps.yaml"
